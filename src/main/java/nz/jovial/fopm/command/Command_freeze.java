...
@CommandParameters(description = "Freeze a player", usage = "/<command> <player>", aliases = "fr", source = SourceType.BOTH, rank = Rank.ADMIN)
public class Command_freeze
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String string, String[] args)
    {
        ...
        Bukkit.broadcast(Component.text(ChatColor.GREEN + sender.getName() + " - " + (data.isFrozen() ? "Unfreezing " : "Freezing ") + player.getName()));
