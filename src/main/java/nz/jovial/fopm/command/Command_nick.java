...
public class Command_nick
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String lbl, String[] args)
    {
        ...
        if (args.length == 1)
        {
            ...
            {
                p.displayName(Component.text(Rank.OP.getColor() + p.getName()));
            ...
            p.displayName(Component.text(FUtil.colorize(args[0])));
        ...
        if (args.length == 2)
        {
            if (AdminList.isAdmin(p))
            {
                ...
                if (args[0].equalsIgnoreCase("off"))
                {
                    t.displayName(Component.text(Rank.OP.getColor() + t.getName()));
                ...
                t.displayName(Component.text(FUtil.colorize(args[0])));
