...
public class Command_ban
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String string, String[] args)
    {
        ...
        if (m.matches())
        {
            ...
            Bukkit.broadcast(Component.text(ChatColor.RED + sender.getName() + " - Banning IP: " + args[0]
        ...
        if (player.isOnline())
        {
            ...
            Bukkit.broadcast(Component.text(ChatColor.RED + sender.getName() + " - Banning " + player.getName()
                    + (reason != null ? "\n Reason: " + ChatColor.YELLOW + reason : "")));
            ...
            p.kick(Component.text(ChatColor.RED + "You have been banned!"));
            return true;
        }
        ...
        Bukkit.broadcast(Component.text(ChatColor.RED + sender.getName() + " - Banning " + args[0]
                + (reason != null ? "\n Reason: " + ChatColor.YELLOW + reason : "")));
