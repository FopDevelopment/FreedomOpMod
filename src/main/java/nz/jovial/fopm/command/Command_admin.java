        ...
        switch (args.length)
        {
            case 2:
            {
                if (args[0].equalsIgnoreCase("add"))
                {
                    ...
                    {
                        Bukkit.broadcast(Component.text(ChatColor.GREEN + sender.getName() + " - Readding " + player.getName() + " to the admin list"));
                        AdminList.imposters.remove(player.getName());
                        AdminList.updateIp(player);
                        return true;
                    }

                    Bukkit.broadcast(Component.text(ChatColor.GREEN + sender.getName() + " - Adding " + player.getName() + " to the admin list"));
                ...
                if (args[0].equalsIgnoreCase("remove"))
                {
                    ...
                    Bukkit.broadcast(Component.text(ChatColor.RED + sender.getName() + " - Removing " + player.getName() + " from the admin list"));
            ...
            case 3:
            {
                if (args[0].equalsIgnoreCase("setrank"))
                {
                    ...
                    Bukkit.broadcast(Component.text(ChatColor.GREEN + sender.getName() + " - Setting " + player.getName() + "'s rank to " + rank.getName()));
